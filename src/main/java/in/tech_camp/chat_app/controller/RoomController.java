...
public class RoomController {
  ...
  @PostMapping("/rooms")
  public String createRoom(@ModelAttribute("RoomForm") @Validated(ValidationOrder.class) RoomForm roomForm,  @AuthenticationPrincipal CustomUserDetail currentUser, BindingResult bindingResult, Model model) {
